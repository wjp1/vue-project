<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>验证码:</label>
        <input type="text" placeholder="请输入验证码" v-model="code" ref="codeRef">
...
export default {
  ...
  methods: {
    ...
    async registerUser(){
      try {
        await this.$store.dispatch('user/userRegsiter',{phone:this.phone,code:this.code,password:this.password})
