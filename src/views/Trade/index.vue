  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
        <span class="username" :class="{selected:isActive == 0}" @click="isActive=0">在线支付</span>
        <span class="username" :class="{selected:isActive == 1}" style="margin-left: 5px" @click="isActive=1">货到付款</span>
      </div>
      <div class="line"></div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch('trade/addressInfo')
    this.$store.dispatch('trade/orderInfo')
  },
  computed:{
    ...mapState('trade',['address','orderList']),
    userDefaultAddress(){
